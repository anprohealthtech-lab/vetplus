-- Fix: v_patients_with_duplicates was returning soft-deleted patients
-- because the base FROM clause had no is_active filter.
...
WHERE p.is_active = true;  -- Fix: exclude soft-deleted patients
