-- Fix v_order_test_progress_enhanced to include sample_received_at as a direct column
-- Issue: TATFloater tries to select sample_received_at but it's not in the view output columns
...
SELECT 
    ...
    o.sample_received_at,  -- ✅ Add as direct output column for TATFloater
    ...
    -- Check verify_status='approved' in result_values
    CASE
...
'Order test progress view with sample_received_at as direct column for TAT tracking';
