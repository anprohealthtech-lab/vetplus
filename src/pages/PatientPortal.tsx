...
import {
  ...
  Clock, CheckCircle, Loader, AlertCircle, KeyRound, Eye, EyeOff, Stethoscope
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-safe-bottom">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img
              ...
              className="h-11 w-auto object-contain drop-shadow-sm transition-transform hover:scale-105 duration-300"
            />
            <div>
              <h1 className="text-lg sm:text-xl font-extrabold text-[#1a3a5c] leading-tight">Vetplus Diagnostics</h1>
              <p className="text-[10px] sm:text-xs text-teal-600 font-bold bg-teal-50 border border-teal-100/50 inline-block px-2.5 py-0.5 rounded-full mt-0.5">
                Patient Portal
              </p>
            </div>
          </div>
          <button
            ...
            className="flex items-center px-3 py-2 text-sm bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium border border-gray-200 ml-2"
          >
      ...
      <footer className="max-w-4xl mx-auto px-4 sm:px-6 pb-8 pt-2">
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-5 shadow-sm border border-gray-200 text-center">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 mb-2 text-gray-700">
