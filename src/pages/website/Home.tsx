        ...
        <div className="flex flex-col">
            ...
            <div className="relative bg-blue-900 overflow-hidden text-white">
                <div className="absolute inset-0 opacity-20">
                    ...
                    {/* Placeholder pattern instead of image to keep it safe */}
                    <div className="w-full h-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-400 to-blue-900 opacity-40"></div>
                </div>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 py-20 lg:py-32">
                    <div className="md:w-2/3">
                        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
                            Advanced Diagnostics for <span className="text-blue-400">Better Health</span>
                        </h1>
                        <p className="text-xl md:text-2xl text-blue-100 mb-10 max-w-2xl leading-relaxed">
                            Experience state-of-the-art medical testing with Vetplus Diagnostics. Accurate results, delivered on time to your phone.
                        </p>
            ...
            <div className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="mt-4 text-xl text-gray-600">Committed to excellence in pathology and patient care.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        ...
                        <div className="bg-purple-50 rounded-2xl p-8 hover:shadow-xl transition-all border border-purple-100 transform hover:-translate-y-1">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-3">Comprehensive Tst</h3>
                            <p className="text-gray-600 leading-relaxed">From routine health checkups to specialized diagnostic profiles, we cover all your testing needs.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-blue-50 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready for your Health Checkup?</h2>
                    <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Explore our wide range of tests or let our expert phlebotomists collect your sample securely from home.</p>
