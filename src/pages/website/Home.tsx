...
import { ArrowRight, ShieldCheck, Clock, Activity, FileText, Star } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="py-20 bg-gray-50 border-t border-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">Trusted by Pet Parents</h2>
                        <div className="mt-4 flex justify-center items-center gap-2">
                            <span className="text-xl font-bold text-gray-800">4.9 / 5.0</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            <p className="text-gray-700 italic mb-6">
                                "The home collection was completely stress-free for my Golden Retriever. The technician was incredibly gentle, and the results came to my WhatsApp the very same evening. Vetplus is amazing!"
                            </p>
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            <p className="text-gray-700 italic mb-6">
                                "As a local clinic, we partner with Vetplus for all advanced profiles. Their accuracy and turn-around time are unmatched in the region. Highly recommended for any serious veterinary care."
                            </p>
                            <div className="font-bold text-gray-900">- Dr. Arishek, DVM</div>
                        </div>
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                            <div className="flex text-yellow-400 mb-4">
                                {[...Array(5)].map((_, i) => (
                            ...
                            <p className="text-gray-700 italic mb-6">
                                "I was so worried about taking my cat to a busy lab. The Vetplus technician came right to our living room. It was over in two minutes with zero drama. Can't thank them enough!"
                            </p>
