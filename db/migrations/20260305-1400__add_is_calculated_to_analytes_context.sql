-- Add is_auto_calculated and is_calculated to v_report_template_context analytes JSON
-- This enables the PDF generator to mark calculated parameters with a * badge

-- Recreate the view with is_auto_calculated and is_calculated fields
...
SELECT 
    ...
    jsonb_agg(
        DISTINCT jsonb_build_object(
            ...
            -- ★ NEW: calculated parameter flags
...
COMMENT ON VIEW public.v_report_template_context IS 'Report template context view - enriched with normal_range_min/max, critical values, value_type, interpretations, AI fields, and is_calculated flags for PDF generation';
