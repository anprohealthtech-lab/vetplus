-- Fix: Format timestamps in IST (Asia/Kolkata) instead of UTC in get_report_template_context
-- This resolves the issue where "Collected On" in PDF showed UTC time (e.g. 04:51 AM)
-- instead of the actual local time (e.g. 10:21 AM IST)
