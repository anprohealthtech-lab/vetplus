-- ============================================================
-- Add sample_received_at and collection_center to report context
--
-- Changes:
--   1. v_report_template_context: expose o.sample_received_at
--   2. get_report_template_context: add receivedAt / receivedAtFormatted
--      and collectionCenter (= location_name, already in order object)
--      to both base_placeholders and the order JSON.
-- ============================================================

-- Step 1: Recreate view with sample_received_at
...
COMMENT ON VIEW public.v_report_template_context IS
  'Report template context — includes sample_received_at and collection_center (location_name)';


-- Step 2: Update the RPC function to expose the new fields
